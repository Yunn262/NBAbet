...
menu elif == "ðŸ”Ž Analisar Jogo":
    ...
    # --- Melhor mercado -----------------------------------------------
    se analysis.get("predictions_plan_gated"):
        aviso de st(
            "âš ï¸ O endpoint de previsÃµes completas (Predictions) exige o "
            "plano Pro da API. Está ver apenas os dados disponíveis no "
